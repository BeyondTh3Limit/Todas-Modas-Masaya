...
<div class="modal" id="modalNomina" aria-hidden="true">
  <div class="modal-content">
    ...
    <form id="formNomina" autocomplete="off">
      ...
      <div class="form-row">
        <div  class="icon-slot" > <img src="img/pago.png" alt=""> </div>
        <div class="form-field">
      ...
      <!-- Bonos / Incentivos -->
      <div class="form-row">
        <div  class="icon-slot" > <img src="img/incentivo.png" alt=""> </div>
        <div class="form-field">
      ...
      <!-- Préstamos -->
      <div class="form-row">
       <div  class="icon-slot" > <img src="img/deduccion.png" alt=""> </div>
        <div class="form-field">
